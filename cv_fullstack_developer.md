...
*   Python, Javascript/Typescript, Go, Java, C/C++, Dart, Kotlin, Swift

### Frontend Frameworks
*   Next.js, Flutter

### Backend Frameworks
*   Fastapi, Django, Gin, Springboot

### Databases
*   PostgreSQL, Superbase, Baserow

### DevOps & Platforms
*   Kubernetes, Linux, Git, Bash, QEMU, libvirt

### AI/Machine Learning
*   Pandas, Numpy, Matplotlib, Pytorch, MLx, Tinygrad

### Other Technical Skills
*   WebRTC, Android NDK, iOS Development, API Design & Integration
