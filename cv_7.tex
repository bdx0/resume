	...
	\firstname{Duong} % Your first name
	\familyname{Bao Duy} % Your last name
	
	% All information in this block is optional, comment out any lines you don't need
	\title{Curriculum Vitae}
	\address{62/7/40D Nguyen Dinh Chinh}{Dist.Phu Nhuan, Ho Chi Minh City, Vietnam}
	\mobile{+841656405505}
	\email{baoduy.duong0206@gmail.com}
	\homepage{baoduyduong0206.appspot.com/info}{baoduyduong0206.com/info} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
	\extrainfo{hello}
