...
%\maketitle
\begin{flushright}
\textcolor{black}{\fbox{\includegraphics[scale=0.6]{pictures/picture.jpg}}}
\end{flushright}
\vspace*{-4.0cm}
\begin{Huge}
...
\href{https://www.facebook.com/baoduy.duong0206}{\includegraphics[scale=0.4]{pictures/fb.png}}
\href{https://www.linkedin.com/in/baoduyduong}{\includegraphics[scale=0.5]{pictures/linkin.png}}
\href{https://twitter.com/duong_bao_duy}{\includegraphics[scale=0.5]{pictures/twitter.png}}
\href{https://plus.google.com/u/0/117631351363463841416/about}{\includegraphics[scale=0.4]{pictures/g+.png}}
\end{flushleft}}
\cvlined{About me}{I am a programmer, a hacker, a contributor of open source projects. I have a solid skill about the linux system, the contribution of open source projects. Special, hands-on 2+ years experience in Android development, such as file management, pdf reader, ... Next, I focus about network security and clojure programming. So, I am happy working friendly or in a close team environment, and apply a positive attitude to every task I undertake.}
...
\cvlined{2007 – Present}{have studied at Science University }
...
\cvlined{•  }{Java software Architecture, Design and Development (JSP \& Servlets, EJB, JMS, JNDI, JDBC, Web Services, Java Sockets, Swing, Multithreading, Design patterns, JNI)}
\cvlined{•  }{OOP / OOD / AOP skills}
\cvlined{•  }{Database design}
\cvlined{•  }{Web and Application Security}
\cvlined{•  }{PL/SQL Development}
\cvlined{•  }{JSP/PHP scripting}
\cvlined{•  }{Open source libraries (Jcifs, Jsch, Log4J, GWT, java for GAE)}
\cvlined{•  }{TCP/IP, HTTP(S), (S)FTP, SMTP, DAV(S), SSH  protocols}
\cvlined{•  }{Web / Application Servers (Apache, Tomcat)}
\cvlined{•  }{Database Servers (MySQL)}
\cvlined{•  }{Experience across full project lifecycle in traditional and agile projects}
\section{\textbf{\phongsection{O}{THER} \phongsection{S}{KILLS}}}
\cvlined{Programming     
languages}{\textsc{Java}, \textsc{Bash script}, \textsc{C/C++}, \textsc{Pascal}, \textsc{Assembler}, \textsc{Javascript}, \textsc{html/css},\textsc{python}, \LaTeX,}
\cvlined{ Operating       
Systems}{Linux Centos, Linux Ubuntu, Unix/Linux, Window XP, Window 7, Window server 2003, v.v… 
}
\cvlined{Databases       }{MS Access, MySql 5.0}
\cvlined{Networking      }{TCP/IP, LANs, WANs, Cisco routers and switches, Linux server }
\cvlined{Miscellaneous tools}{Matlab, Maple, OpenOffice.org, Microsoft Office, Eclipse, Skype, Yahoo! Messenger, GNU basic tools}
...
\cventry{}{\phongsection{A}{NDROID} \phongsection{D}{EVELOPER}}{}{}{}{}
